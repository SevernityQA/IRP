...
#Region ErrorMessages
	...
	Strings.Insert("Error_094", NStr("en='Сan not use confirmation of shipment without goods receipt';
		|ru='Нельзя использовать подтверждение отправки товара без подтверждения о его получении. ';
...
#Region InfoMessages
	...
	Strings.Insert("InfoMessage_023", NStr("en='Сan not use confirmation of shipment without goods receipt. Use goods receipt mode is enabled.';
		|ru='Нельзя использовать подтверждение отправки товара без подтверждения о его получении. Необходимо включить режим ""Использовать приходную товарную накладную"".';
